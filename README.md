...
- **Full gameplay loop:** movement, physical interaction, physics, win detection, and a scoring UI.
...
4. **Get it in the hole.** Near the cup, the ball is gently pulled in, then plays a satisfying shrink-and-sink animation.
